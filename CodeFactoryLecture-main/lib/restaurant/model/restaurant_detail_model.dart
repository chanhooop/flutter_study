...
class RestaurantDetailModel extends RestaurantModel {
  ...
  @JsonKey(fromJson: toProductList)
  ...
  static toProductList(List<dynamic> val) {
    return val
        .map<RestaurantProductModel>((x) => RestaurantProductModel.fromJson(x))
        .toList();
  }
...
//           .map<RestaurantProductModel>((x) => RestaurantProductModel.fromJson(json: x))
//           .toList(),
//     );
}
